...
.cinematic-footer-wrapper {
  ...
  /* Dynamic Variables using HSL-wrapped shadcn tokens */
...
// -------------------------------------------------------------------------
// 3. MARQUEE ITEM (Compileme Features)
// -------------------------------------------------------------------------
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Görev Yönetimi</span> <span className="text-primary/60">✦</span>
    <span>Proje Takibi</span> <span className="text-secondary/60">✦</span>
    <span>Eğitim Planlama</span> <span className="text-primary/60">✦</span>
    <span>Fikir Havuzu</span> <span className="text-secondary/60">✦</span>
    <span>Odak Modu</span> <span className="text-primary/60">✦</span>
    <span>Takvim Görünümü</span> <span className="text-secondary/60">✦</span>
    <span>Su Takibi</span> <span className="text-primary/60">✦</span>
  </div>
)
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-border/50">
              ...
              <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">Görkem</span>
            </div>
